    ...
    pages: {
      ...
      servicos: {
        ...
        groups:[
          ...
          { i:'activate', home:false, img:'servicos/instalacao-e-ativacao.jpg', t:'Instalação e ativação de serviços', d:'Instalação de equipamentos e soluções técnicas, ativação e entrega de serviços de telecomunicações ao cliente final, numa abordagem end-to-end.', subs:['Instalação de equipamentos','Ativação de serviços','Entrega ao cliente final','End-to-end (E2E)'] },
    ...
    pages: {
      ...
      servicos: {
        ...
        groups:[
          ...
          { i:'activate', home:false, img:'servicos/instalacao-e-ativacao.jpg', t:'Installation & service activation', d:'Installation of equipment and technical solutions, activation and delivery of telecommunications services to the end customer, end-to-end.', subs:['Equipment installation','Service activation','End-customer delivery','End-to-end (E2E)'] },
