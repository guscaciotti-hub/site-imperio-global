...
const ASSET_V = 'v=20260918a';  // muda quando uma imagem é reeditada (força recarregamento)
...
const FLAGS = {
  pt: '<img src="{up}assets/img/bandeira-pt.png" alt="Portugal" loading="lazy">',
...
const STRINGS = {
    ...
    pages: {
      ...
      servicos: {
        ...
        groups:[
          ...
          { i:'monitor', home:false, img:'servicos/supervisao-e-monitorizacao.jpg', semNum:true, t:'Supervisão e monitorização', d:'Coordenamos e supervisionamos as operações no terreno com rigor e precisão, assegurando uma execução eficiente, o cumprimento dos padrões de qualidade e a excelência operacional.', subs:['Supervisão de redes','Monitorização','Controlo operacional','Gestão de operações'] },
  ...
  en: {
    ...
    cta: { title:'Want to know more?', text:'Talk to us and find out how we can support the growth of your business.', btn:'Contact us' },
    pages: {
      index: {
        ...
        heroTitle:'We develop infrastructure that connects people, businesses and communities.',
        ...
        heroStats:[ { v:'9', l:'years of operation' }, { v:'50+', l:'specialised professionals' }, { v:'2', l:'countries of operation' } ],
      ...
      sobre: {
        ...
        heroSub:'Specialists in the construction, installation, maintenance and certification of telecommunications infrastructure and networks.',
        heroCta:'Get in touch',
        intro:'Founded in 2017, Império Global Telecomunicações is a Portuguese company specialising in the construction, installation, maintenance and certification of telecommunications infrastructure and networks. With an experienced team and a strong commitment to quality, innovation and safety, we develop reliable, efficient solutions tailored to the needs of each project.',
        missaoT:'Our Mission',
        missao:'Our mission is to develop telecommunications solutions that ensure reliable, secure and efficient connections, contributing to the evolution of communication infrastructure. We operate with rigour, innovation and commitment, creating value for our clients and partners in every project.',
        visaoT:'Our Vision',
        visao:'To be a national and international reference in the delivery of technical infrastructure, distinguished by innovation, operational excellence and the trust of our clients, contributing to a more connected and sustainable future.',
        valoresT:'Our Values',
        valores:[
          { t:'Client focus', d:'We put our clients at the centre of everything we do, developing solutions tailored to their needs.' },
          { t:'People', d:'We value people, promoting teamwork, continuous development and an environment of respect and collaboration.' },
          { t:'Innovation', d:'We invest in continuous improvement, technology and new solutions that drive efficiency and the evolution of the sector.' },
          { t:'Commitment', d:'We act with responsibility, rigour and dedication, honouring our commitments in every project.' },
          { t:'Trust', d:'We build lasting relationships based on transparency, integrity and the excellence of our services.' },
        ],
      ...
      servicos: {
        ...
        intro:'We design, build and certify telecommunications infrastructure, developing high-quality solutions that ensure performance, reliability and connectivity for an increasingly digital future.',
        items:[
        ...
        groups:[
          ...
          { i:'monitor', home:false, img:'servicos/supervisao-e-monitorizacao.jpg', semNum:true, t:'Supervision & monitoring', d:'Continuous supervision and monitoring of networks, ensuring operational control, performance and alignment of field operations.', subs:['Network supervision','Monitoring','Operational control','Operations management'] },
  ...
  fr: {
    ...
    cta: { title:'Vous souhaitez en savoir plus ?', text:'Parlez-nous et découvrez comment nous pouvons soutenir la croissance de votre activité.', btn:'Contactez-nous' },
    pages: {
      index: {
        ...
        heroTitle:'Nous développons des infrastructures qui relient les personnes, les entreprises et les communautés.',
        ...
        heroStats:[ { v:'9', l:'ans d’activité' }, { v:'50+', l:'professionnels spécialisés' }, { v:'2', l:'pays d’activité' } ],
      ...
      sobre: {
        ...
        heroSub:"Spécialistes de la construction, de l'installation, de la maintenance et de la certification d'infrastructures et de réseaux de télécommunications.",
        heroCta:'Contactez-nous',
        intro:"Fondée en 2017, Império Global Telecomunicações est une entreprise portugaise spécialisée dans la construction, l'installation, la maintenance et la certification d'infrastructures et de réseaux de télécommunications. Avec une équipe expérimentée et un engagement fort envers la qualité, l'innovation et la sécurité, nous développons des solutions fiables et efficaces, adaptées aux besoins de chaque projet.",
        missaoT:'Notre Mission',
        missao:"Notre mission est de développer des solutions de télécommunications garantissant des connexions fiables, sûres et efficaces, contribuant à l'évolution des infrastructures de communication. Nous agissons avec rigueur, innovation et engagement, en créant de la valeur pour nos clients et partenaires dans chaque projet.",
        visaoT:'Notre Vision',
        visao:"Être une référence nationale et internationale dans la réalisation d'infrastructures techniques, en nous distinguant par l'innovation, l'excellence opérationnelle et la confiance de nos clients, pour un avenir plus connecté et durable.",
        valoresT:'Nos Valeurs',
        valores:[
          { t:'Orientation client', d:"Nous plaçons nos clients au cœur de tout ce que nous faisons, en développant des solutions adaptées à leurs besoins." },
          { t:'Les personnes', d:"Nous valorisons les personnes, en favorisant le travail d'équipe, le développement continu et un environnement de respect et de collaboration." },
          { t:'Innovation', d:"Nous investissons dans l'amélioration continue, la technologie et de nouvelles solutions qui stimulent l'efficacité et l'évolution du secteur." },
          { t:'Engagement', d:'Nous agissons avec responsabilité, rigueur et dévouement, en honorant nos engagements dans chaque projet.' },
          { t:'Confiance', d:"Nous bâtissons des relations durables fondées sur la transparence, l'intégrité et l'excellence de nos services." },
        ],
      ...
      servicos: {
        ...
        intro:"Nous concevons, construisons et certifions des infrastructures de télécommunications, en développant des solutions de haute qualité qui garantissent performance, fiabilité et connectivité pour un avenir toujours plus numérique.",
        items:[
        ...
        groups:[
          ...
          { i:'monitor', home:false, img:'servicos/supervisao-e-monitorizacao.jpg', semNum:true, t:'Supervision & surveillance', d:'Supervision et surveillance continue des réseaux, assurant le contrôle opérationnel, la performance et la coordination des opérations sur le terrain.', subs:['Supervision de réseaux','Surveillance','Contrôle opérationnel','Gestion des opérations'] },
      ...
      <div class="container">
        ...
        <div class="presenca-flags rv">${['pt', 'be'].map((fl, i) => `
          <div class="presenca-flag">
            <figure class="presenca-flag__flag">${(FLAGS[fl] || '').replace('{up}', up)}</figure>
  ...
  const rows = p.groups.map((g, idx) => `
        <article class="svc-row${idx % 2 ? ' svc-row--rev' : ''} rv">
          <div class="svc-row__media${g.img ? ' svc-row__media--photo' : ''}${g.fit === 'contain' ? ' svc-row__media--contain' : ''}"${g.img ? ` style="background-image:url('${up}assets/img/${g.img}?${ASSET_V}')"` : ''}>
            ${g.semNum ? '' : `<span class="svc-row__num" aria-hidden="true">${String(idx + 1).padStart(2, '0')}</span>`}
...
const HOME_EXTRA = {
  pt: { blogEyebrow:'Insights', blogTitle:'Do nosso blog', blogAll:'Ver o blog',
    ...
    nlText:'Receba as nossas análises sobre construção, expansão e manutenção de infraestruturas de telecomunicações. Um email por mês — cancele quando quiser.',
...
<p><strong>Leitura relacionada:</strong> <a href="manutencao-preventiva-fibra-otica.html">Manutenção preventiva em redes de fibra ótica: quando compensa</a> — o outro lado da decisão.</p>
`,
      },
    },
  },
